  ...
  <div className="container px-5 py-24 mx-auto flex flex-wrap">
    <div className="flex flex-wrap -mx-4 mt-auto mb-auto lg:w-1/2 sm:w-2/3 content-start sm:pr-10 ml-[10px]">
      <div className="w-full sm:p-4 px-4 mb-6">
        ...
        <div className="leading-relaxed text-[2rem] mt-5 lg:w-[440px] md:w-[100px]">I will never go back to ordering food online because ChefKart just works great for me!</div>
       <p className='text-[#e76f51] text-xl font-bold mt-5'>Pramiti Upadhyay</p>
      </div>
    </div>
